...
public record OrderFill(
    ...
    public OrderFill(
        ...
        this(strategyId, symbol, inputSequence, marketTimestamp, correlationId, orderId,
                side, Quantity.fromInt(quantity), price, position, realizedPnl, commission,
    ...
    public OrderFill(
            ...
            double realizedPnl) {
        this(strategyId, symbol, inputSequence, marketTimestamp, correlationId, orderId,
                side, Quantity.fromInt(quantity), price, position, realizedPnl, Commission.zero("USD"),
                LiquiditySide.TAKER, "");
    }
    ...
    public OrderFill(
            ...
            Commission commission) {
        this(strategyId, symbol, inputSequence, marketTimestamp, correlationId, orderId,
                side, Quantity.fromInt(quantity), price, position, realizedPnl, commission, LiquiditySide.TAKER, "");
    }
