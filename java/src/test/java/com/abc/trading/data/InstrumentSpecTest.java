...
class InstrumentSpecTest {
    ...
    void validatesSizePrecisionAndIncrement() {
        ...
        instrument.validatePrice(30000.0);
        assertThrows(IllegalArgumentException.class,
                () -> instrument.validateQuantity(Quantity.fromString("0.0015", 4)));
        assertThrows(IllegalArgumentException.class, () -> instrument.validatePrice(30000.05));
    }
    ...
    void derivesInstrumentPrecisionFromBinanceStepSize() {
        ...
        assertEquals(1, metadata.pricePrecision());
        assertEquals(3, metadata.toInstrumentSpec("BINANCE").sizePrecision());
        assertEquals(new BigDecimal("0.1"), metadata.toInstrumentSpec("BINANCE").priceTickSize());
        ...
        assertThrows(IllegalArgumentException.class,
                () -> BinanceOrderValidator.validate(metadata, new BigDecimal("0.001"), new BigDecimal("100.05")));
    }
}
